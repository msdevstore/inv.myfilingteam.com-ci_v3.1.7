...
class Invoice extends Home_Controller {
    ...
    public function edit($id, $type=0)
    {
        ...
        $data['products'] = $this->admin_model->get_by_user_and_type('products', 'is_sell');
        $data['discount'] = $data['invoice'][0]['discount'];
        $data['adjustment'] = $data['invoice'][0]['adjustment'];
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $hsns = $this->input->post('hsn', true);
            $details = $this->input->post('details', true);
            $price = $this->input->post('price', true);
            $quantity = $this->input->post('quantity', true);
            $unit = $this->input->post('unit', true);
            $tax_ids = $this->input->post('taxes', true);
    ...
    public function load_gsts()
    {
        $data = $this->admin_model->get_user_taxes_by_gst();
        if (empty($data)) {
            echo 0;
        }else{
            echo json_encode($data);
    ...
    public function preview()
    {
        ...
        $products = array(
            ...
            'detail' => $this->input->post('details', true),
            'hsn' => $this->input->post('hsn', true),
            'unit' => $this->input->post('unit', true),
            'price' => $this->input->post('price', true),
            'tax_name' => $this->input->post('tax_name', true),
            'tax_rate' => $this->input->post('tax', true),
            'details' => $this->input->post('details', true),
            'quantity' => $this->input->post('quantity', true),
            'total_price' => $this->input->post('total_price', true),
