                                    ...
                                    <div class="row inv-info">
                                        ...
                                        <div class="col-xs-6 col-md-12 text-right">
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-6 text-right control-label col-form-label"><?php echo trans('invoice-number') ?></label>
                                                <div class="col-sm-4">
                                                    <?php if (isset($page_title) && $page_title == 'Edit Invoice'): ?>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-6 text-right control-label col-form-label"><?php echo trans('p.o.s.o.-number') ?></label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-6 text-right control-label col-form-label"><?php echo trans('invoice-date') ?></label>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group row mt-10">
                                                <label for="inputEmail3" class="col-sm-6 text-right control-label col-form-label"><?php echo trans('payment-due-date') ?></label>
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                ...
                                <div class="col-md-12 p-0">
                                    <div class="table-responsive invcus-table">
                                        <table class="table">
                                                ...
                                                <?php foreach ($items as $product): ?>
                                                    <tr class="item-row">
                                                        <td width="15%">
                                                            ...
                                                            <input type="hidden" class="form-control item" placeholder="Item" type="text" name="items[]" value="<?php echo html_escape($product->item_id) ?>">
                                                        </td>
                                                        <td width="25%">
                                                        ...
                                                        <td width="8%">
                                                            <input type="text" class="form-control hsn" placeholder="" type="text" name="hsn[]" value="<?php echo html_escape($product->hsn) ?>">
                                                        </td>
                                                        <td width="8%">
                                                            <input class="form-control qty" placeholder="Quantity" type="text" name="quantity[]" value="<?php echo html_escape($product->qty) ?>">
                                                        </td>
                                                        <td width="7%">
                                                            <input type="text" class="form-control unit" placeholder="" type="text" name="unit[]" value="<?php echo html_escape($product->unit) ?>">
                                                        </td>
                                                        <td width="8%">
                                                        ...
                                                        <td width="14%">
                                                            ...
                                                            <input type="hidden" class="tax" id="tax_<?php echo $product->id ?>" value="" name="tax[]">
                                                            <input type="hidden" class="tax_name" id="tax_name_<?php echo $product->id ?>" value="" name="tax_name[]">
                                                        </td>
                                                        <td width="15%">
                                                            <div class="delete-btn">
                                                                ...
                                                                <input type="hidden" name="product_ids[]" value="<?php echo html_escape($product->item_id) ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endforeach ?>
                                            ...
                                            <input type="hidden" class="discount" name="discount" value="<?php echo $discount; ?>">
                                            <input type="hidden" class="adjustment" name="adjustment" value="<?php echo $adjustment; ?>">
                                            <input type="hidden" id="currency_wrapper" value="">
                                            </tbody>
                                            <tbody id="info"></tbody>
                                        </table>
                                    </div>
