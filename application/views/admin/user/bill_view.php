                    ...
                    <div class="row mb-10">
                        <div class="col-md-6">
                            ...
                            <?php if (settings()->pdf_type == 1): ?>
                                <a href="#" data-id="invoice_<?php echo rand() ?>" class="btn btn-default btn-rounded mr-5 btnExport"> <?php echo trans('download-pdf') ?> </a>
                            <?php else: ?> 
                                <a href="<?php echo base_url('extract/export_pdf/'.md5($invoice->id)) ?>" class="btn btn-default btn-rounded mr-5"><?php echo trans('download-pdf') ?> </a>
                            <?php endif ?>
                        </div>
