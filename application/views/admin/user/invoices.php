                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu st" x-placement="bottom-start">
                                                                ...
                                                                <!-- <a class="dropdown-item" href="<?php //echo base_url('extract/export_pdf/'.md5($invoice->id)) ?>"><?php //echo trans('export-as-pdf') ?></a> -->
                                                                ...
                                                                <a target="_blank" class="dropdown-item" href="<?php echo base_url('extract/invoice/view/'.md5($invoice->id)) ?>"><?php echo trans('share-link') ?></a>
