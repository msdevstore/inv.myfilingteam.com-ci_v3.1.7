                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php foreach ($estimates as $estimate): ?>
                                                <tr id="row_<?php echo html_escape($estimate->id) ?>">
                                                    ...
                                                    <td><?php echo price_formatted_alt($estimate->grand_total, $this->business->id, $currency_symbol) ?></td>
                                                    <td class="text-right">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu st" x-placement="bottom-start">
                                                                <?php if(auth('role') != 'viewer'): ?>
                                                                    ...
                                                                    <a target="_blank" class="dropdown-item" href="<?php echo base_url('extract/estimate/preview/'.md5($estimate->id)) ?>"><?php echo trans('preview-as-a-customer') ?></a>
