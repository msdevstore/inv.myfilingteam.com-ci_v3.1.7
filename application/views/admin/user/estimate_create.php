        ...
        <form id="estimate_form" method="post" enctype="multipart/form-data" class="validate-form leave_con" action="<?php echo base_url('admin/estimate/add')?>" role="form" novalidate>
                              ...
                              <div class="panel-body inv">                      
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php else: ?>
                                            <input type="text" class="form-control text-right" name="title" placeholder="<?php echo trans('estimate-title') ?>" value="">
                                        <?php endif ?>
                                            ...
                                            <?php foreach ($items as $product): ?>
                                                <tr class="item-row">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" class="tax" id="tax_<?php echo $product->id ?>" value="">
                                                        <input type="hidden" class="tax_name" id="tax_name_<?php echo $product->id ?>" value="">
                                                    </td>
                                                    <td width="15%">
                        ...
                        <div class="panel panel-default inv">
                            ...
                            <div id="collapse2" class="panel-collapse data_collaps_border collapse" role="tabpanel" aria-labelledby="heading2" aria-expanded="false" style="height: 1px;">
                              <div class="panel-body inv">                      
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea class="form-control" rows="4" name="footer_note" placeholder="<?php echo trans('invoice-footer-placeholder') ?>"><?php echo $invoice[0]['footer_note']; ?></textarea>
                                    </div>
                                </div>
                              </div>
                            </div>
            ...
            <div class="row mb-20">
                <div class="col-md-12 text-center p-20">
                    <button type="submit" class="btn btn-info btn-rounded save_estimate_btn"><i class="fa fa-check"></i> <?php if(isset($page_title) && $page_title == 'Edit Estimate'){echo "Update";}else{echo trans('save');} ?></button>
                </div>
            </div>
