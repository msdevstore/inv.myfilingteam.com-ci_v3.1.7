                ...
                <?php $i=1; foreach ($payments as $payment): ?>
                  ...
                  <?php if ($payment->amount != '0.00'): ?>
                    <tr id="row_<?php echo html_escape($payment->id); ?>">
                        ...
                        <td><?php echo price_formatted($payment->amount, 'site'); ?></td>
                        ...
                        <td class="actions" width="30%">
                          ...
                          <!-- <a target="_blank" href="<?php //echo base_url('extract/export_invoice/'.$payment->puid) ?>" class="pull-right btn btn-default btn-sm mr-10"><i class="fa fa-cloud-download"></i> <?php //echo trans('download-pdf') ?></a> -->
                        </td>
                    </tr>
                  <?php endif ?>
